...
8. [**`008_bar_raiser_design_patterns_and_data_structures_audit.md`**](file:///home/rujanad/worldclass-workspace/node-erp-app/docs/sdlc/003-design/architectural-lineage/008_bar_raiser_design_patterns_and_data_structures_audit.md): Matriz de Auditoría Bar Raiser: Patrones de Diseño Formales (GoF / PoEAA) y Estructuras de Datos de Bajo Nivel por Hito.
9. [**`009_database_design_patterns_and_anti_patterns.md`**](file:///home/rujanad/worldclass-workspace/node-erp-app/docs/sdlc/003-design/architectural-lineage/009_database_design_patterns_and_anti_patterns.md): Matriz de Auditoría Bar Raiser de Persistencia: Patrones Formales de Modelado Relacional (3NF, SAP Mandante, Ledger, Outbox) vs Anti-Patrones de Base de Datos.
